					...
					<div class="panel-body">
						<form method="post" accept-charset="UTF-8" action="AjoutVoie">
							<div class="panel-body form-horizontal payment-form">
								...
								<c:set var="exposition" value="${ voie.exposition }"
									scope="request" />
								...
								<fieldset>
									...
									<div class="form-group">
										<label for="nom" class="col-sm-4 control-label">Nom
											voie <span class="requis">*</span>
										</label>
										<div class="col-sm-5">
											<input type="text" class="form-control" id="nomvoie"
												name="nomvoie" value="<c:out value="${voie.nom_voie}"/>">
											<span class="erreur">${formvoie.erreurs['nomvoie']}</span>
										</div>
									</div>

									<div class="form-group">
										<label class="col-xs-4 control-label">Secteur<span
										...
										<div class="col-sm-5 selectContainer">
											<select class="form-control" name="idsecteur" id="idsecteur">
												...
												<c:forEach items="${ sessionScope.sessionSecteur}"
													var="secteurs">
													<option value="<c:out value="${ secteurs.key}" />"><c:out
															value="${ secteurs.key}" /></option>
												</c:forEach>
											</select> <span class="erreur">${formvoie.erreurs['idsecteur']}</span>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" id="altitude"
												name="altitude" value="<c:out value="${voie.altitude}"/>">
											<span class="erreur">${formvoie.erreurs['altitude']}</span>
										</div>
									</div>


									<div class="form-group">
										<label for="nbrlongueur" class="col-sm-4 control-label">Nombre
											de longueur </label>
										<div class="col-sm-5">
											<input type="text" class="form-control" id="nbrlongueur"
												name="nbrlongueur"
									...
									<div class="form-group">
										<label class="col-xs-4 control-label">Cotation <span
											class="requis">*</span></label>
										<div class="col-sm-5 selectContainer">
											<select class="form-control" name="idcotation"
												id="idcotation">
											...
											</select> <span class="erreur">${formvoie.erreurs['idcotation']}</span>
											Si la cotation n'existe pas vous pouvez <a
												href="<c:url value="AjoutCotation" />">l'ajouter</a>

										</div>
									</div>

									<div class="form-group">
										<label class="col-xs-4 control-label">Exposition <span
											class="requis">*</span></label>
										<div class="col-sm-5 selectContainer">
											<select class="form-control" name="idexposition"
												id="idexposition">
