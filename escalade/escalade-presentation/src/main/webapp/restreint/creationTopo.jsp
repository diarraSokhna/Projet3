	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>
					<b>Proposez un topo</b>
				</h4>
			</div>
			<div class="panel-body">
				<form method="post" accept-charset="UTF-8" action="CreationTopo"
					...
					<div class="panel-body form-horizontal payment-form">
						<fieldset>
							...
							<div class="form-group">
								<label for="nom" class="col-sm-4 control-label">Nom <span
									class="requis">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="nom" name="nom"
										value="<c:out value="${topo.nom}"/>"> <span
										class="erreur">${form.erreurs['nom']}</span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-4 control-label">La liste des sites<span
									class="requis">*</span></label>
								<div class="col-sm-5 selectContainer">
									<select multiple class="form-control" name="listeSite"
										id="listeSite">
										<!--             <option value="0"> Choisir un site </option> -->
										<c:forEach var="site" items="${ sites }">
											<option value="${site.idsite}"
												${param.site eq site.idsite ? 'selected' : ''}>${site.nomsite}</option>
										</c:forEach>
									</select> <span class="erreur">${form.erreurs['listeSite']}</span> Si le
									site n'existe pas vous pouvez l'<a
										href="<c:url value="/AjoutSite" />">ajouter</a>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="nbpage" class="col-sm-4 control-label">Nombre
									de page</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="nbrpage"
										name="nbrpage" value="<c:out value="${topo.nbpage}"/>">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="file" class="form-control-file" id="image"
										name="image" value="<c:out value="${topo.image}"/>"
