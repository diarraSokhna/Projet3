              ...
              <fieldset>
                ...
                <legend>Ajouter Article </legend>
                    ...
                    <div class="form-group">
                        <label for="titre" class="col-sm-3 control-label">Titre <span class="requis">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="titre" name="titre" value="<c:out value="${article.titre}"/>" >
                            <span class="erreur">${form.erreurs['titre']}</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="contenu" class="col-sm-3 control-label">Contenu <span class="requis">*</span></label>
                        <div class="col-sm-9">
                            <textarea  class="form-control" id="contenu" name="contenu" value="<c:out value="${article.contenu}"/>" >
                           </textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="file" class="form-control-file" id="photo" name="photo" value="<c:out value="${artilce.photo}"/>" onchange="" multiple/>
