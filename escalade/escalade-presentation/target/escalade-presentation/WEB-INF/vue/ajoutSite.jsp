...
<%--                 <input type="text"  class="form-control" id="idpays" name="idpays" value="<c:out value="${ pays.idpays}" />" /> --%>
            ...
            <span class="erreur">${form.erreurs['pays']}</span>
             Si le pays n'existe pas vous pouvez <a href="">l'ajouter</a>
                    ...
                    <div class="form-group">
                        <label for="exposition" class="col-sm-3 control-label">Exposition <span class="requis">*</span></label>
                        <div class="col-sm-9">
                            <input type="text"  class="form-control" id="exposition" name="exposition" value="<c:out value="${site.exposition}"/>" />
                    ...
                    <div class="form-group">
                        <label for="classement" class="col-sm-3 control-label">Classement</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="classement" name="classement" value="<c:out value="${site.classement}"/>" >
                            <span class="erreur">${form.erreurs['classement']}</span>
                        </div>
                    </div>
