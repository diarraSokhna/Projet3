...
public class CommentaireDaoImpl implements CommentaireDao {
	...
	public void laisser(Commentaire commentaire) throws DaoException {
		...
		try {
			...
			preparedStatement = initialisationRequetePreparee(connexion, SQL_INSERT, true, commentaire.getLibelle(),
					commentaire.getUtilisateur().getIduser(), commentaire.getTopo().getIdtopo());
