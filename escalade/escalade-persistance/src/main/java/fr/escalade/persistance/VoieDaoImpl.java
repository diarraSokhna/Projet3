...
public class VoieDaoImpl implements VoieDao {
	...
	public void creerVoie(Voie voie, Secteur secteur) throws DaoException {
		...
		try {
			...
			preparedStatement = initialisationRequetePreparee(connexion, SQL_INSERT, true, secteur.getIdsect(),
					voie.getCotation().getIdcot(), voie.getNom_voie(), voie.getAltitude(), voie.getNbr_longueur(),
