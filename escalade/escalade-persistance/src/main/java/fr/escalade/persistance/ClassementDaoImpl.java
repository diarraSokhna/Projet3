...
public class ClassementDaoImpl implements ClassementDao{
	...
	public void creer(Classement classement) throws DaoException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_INSERT, true, classement.getLibelle_class());
	...
	public void supprimer(Classement classement) throws DaoException {
		 Connection connexion = null;
	        ...
	        try {
	            connexion = daoFactory.getConnection();
	            preparedStatement = initialisationRequetePreparee( connexion, SQL_DELETE_PAR_ID, true, classement.getId_class());
	            int statut = preparedStatement.executeUpdate();
	            if ( statut == 0 ) {
