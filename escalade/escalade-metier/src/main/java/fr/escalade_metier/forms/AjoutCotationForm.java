	...
	public Cotation creerCotation(HttpServletRequest request) {
		...
		try {
			if (erreurs.isEmpty()) {
				...
				resultat = "Échec de la création de la cotation.";
			}
		} catch (DaoException e) {
			setErreur("imprévu", "Erreur imprévue lors de la création.");
			resultat = "Échec de la création de la cotation : une erreur imprévue est survenue, merci de réessayer dans quelques instants.";
			e.printStackTrace();
		}
